/**
 * Windowed Count View - Groups events into 5-minute windows
 * Shows: Window Start | Window End | Event Count
 */
class WindowedCountView {
    constructor(containerId) {
        this.container = document.getElementById(containerId);
        this.tableBody = null;
        this.windowSizeMs = 5 * 60 * 1000; // 5 minutes in milliseconds
        this.windows = new Map(); // Map of window start time -> count
        this.init();
    }

    init() {
        this.container.innerHTML = `
            <table id="windowedCountTable">
                <thead>
                    <tr>
                        <th>Window Start</th>
                        <th>Window End</th>
                ...
                <tbody id="windowedCountTableBody">
                    <tr>
        ...
        `;
        this.tableBody = document.getElementById('windowedCountTableBody');
    }
    ...
    refresh() {
        ...
        sortedWindows.forEach(([windowStartMs, count]) => {
